...
1. ❗️ Closed issue [#6690](https://github.com/open-metadata/OpenMetadata/issues/6690) in [open-metadata/OpenMetadata](https://github.com/open-metadata/OpenMetadata)
2. 🎉 Merged PR [#6691](https://github.com/open-metadata/OpenMetadata/pull/6691) in [open-metadata/OpenMetadata](https://github.com/open-metadata/OpenMetadata)
3. 🎉 Merged PR [#144](https://github.com/open-metadata/docs/pull/144) in [open-metadata/docs](https://github.com/open-metadata/docs)
4. ❗️ Opened issue [#6686](https://github.com/open-metadata/OpenMetadata/issues/6686) in [open-metadata/OpenMetadata](https://github.com/open-metadata/OpenMetadata)
5. 🎉 Merged PR [#6651](https://github.com/open-metadata/OpenMetadata/pull/6651) in [open-metadata/OpenMetadata](https://github.com/open-metadata/OpenMetadata)
6. ❗️ Opened issue [#6681](https://github.com/open-metadata/OpenMetadata/issues/6681) in [open-metadata/OpenMetadata](https://github.com/open-metadata/OpenMetadata)
7. 🎉 Merged PR [#142](https://github.com/open-metadata/docs/pull/142) in [open-metadata/docs](https://github.com/open-metadata/docs)
8. 🗣 Commented on [#142](https://github.com/open-metadata/docs/issues/142) in [open-metadata/docs](https://github.com/open-metadata/docs)
9. 💪 Opened PR [#142](https://github.com/open-metadata/docs/pull/142) in [open-metadata/docs](https://github.com/open-metadata/docs)
10. 🎉 Merged PR [#141](https://github.com/open-metadata/docs/pull/141) in [open-metadata/docs](https://github.com/open-metadata/docs)
